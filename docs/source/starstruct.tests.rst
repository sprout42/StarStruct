...
.. toctree::
   ...
   starstruct.tests.test_elementlength
   starstruct.tests.test_elementnum
   starstruct.tests.test_elementpad
   starstruct.tests.test_elementstring
